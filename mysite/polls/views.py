...
def get_report(request):
    try:
        ...
        html_report_object = HTML_REPORT(req_data['report_title'], req_data['theme'], req_data['test_info'], req_data['report_table_title'], req_data['report_cases'])
            ...
            return JsonResponse(
                {
                    ...
                    'data': {
                        ...
                        'report_url': 'http://{}:{}/polls/report/?name={}'.format(ips, port, report_name),
